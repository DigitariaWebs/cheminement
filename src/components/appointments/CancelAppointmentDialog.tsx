              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-yellow-700 dark:text-yellow-300">
                    {isFreeCancel ? (
                      <>
                        You can cancel this appointment for free since it&apos;s
                        more than {HOURS_FOR_FREE_CANCELLATION} hours away.
                      </>
                    ) : (
                      <>
                        Cancellations within {HOURS_FOR_FREE_CANCELLATION} hours
                        are subject to a {CANCELLATION_FEE_PERCENTAGE}%
                        cancellation fee.
                      </>
                    )}
                  </p>
